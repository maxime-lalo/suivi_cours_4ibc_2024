...
export default abstract class ApiResponses {
  ...
  public static httpSuccess<T extends Response>(
    response: T,
    responseData: IResponseJson<T>
  ) {
    return this.httpResponse(response, HttpCodes.SUCCESS, responseData);
  }

  public static httpCreated<T extends Response>(
    response: T,
    responseData: IResponseJson<T>
  ) {
  ...
  public static httpUpdated<T extends Response>(
    response: T,
    responseData: IResponseJson<T>
  ) {
    return this.httpResponse(response, HttpCodes.SUCCESS, responseData);
  ...
  public static httpBadRequest(
    response: Response,
    responseData: IResponseData = "Http Bad Request"
  ) {
    return this.httpResponse(response, HttpCodes.BAD_REQUEST, responseData);
  }

  public static httpMalformedRequest(
    response: Response,
    responseData: IResponseData = "Malformed Request"
  ) {
    return this.httpResponse(response, HttpCodes.BAD_REQUEST, responseData);
  }

  public static httpNotFound(
    response: Response,
    responseData: IResponseData = "Not Found"
  ) {
  ...
  public static httpInternalError(
    response: Response,
    responseData: IResponseData = "http Internal Server Error"
  ) {
    return this.httpResponse(response, HttpCodes.INTERNAL_ERROR, responseData);
  }

  public static httpUnauthorized(
    response: Response,
    responseData: IResponseData = "http Unauthorized Request"
  ) {
    return this.httpResponse(response, HttpCodes.UNAUTHORIZED, responseData);
  }

  public static httpNotImplemented(
    response: Response,
    responseData: IResponseData = "Not implemented"
  ) {
    return this.httpResponse(response, HttpCodes.NOT_IMPLEMENTED, responseData);
  }

  public static httpForbidden(
    response: Response,
    responseData: IResponseData = "Forbidden"
  ) {
